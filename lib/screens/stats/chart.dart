...
class _MyChartState extends State<MyChart> {
  ...
  List<BarChartGroupData> showingGroups() => List.generate(8, (i) {
        switch (i) {
          case 0:
            return makeGroupData(0, 2, Colors.red);
          case 1:
            return makeGroupData(1, 3, Colors.blue);
          case 2:
            return makeGroupData(2, 2, Colors.green);
          case 3:
            return makeGroupData(3, 4.5, Colors.yellow);
          case 4:
            return makeGroupData(4, 3.8, Colors.purple);
          case 5:
            return makeGroupData(5, 1.5, Colors.orange);
          case 6:
            return makeGroupData(6, 4, Colors.brown);
          case 7:
            return makeGroupData(7, 3.8, Colors.cyan);
          default:
            return throw Error();
        }
      });
